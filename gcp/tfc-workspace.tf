...
resource "tfe_variable_set" "tfe_var_set" {
  name         = "Google Cloud dynamic credentials"
  description  = "GCP dynamic credentials applied to all workspaces."
  global       = true
...
# #
# # https://registry.terraform.io/providers/hashicorp/tfe/latfe_var_set/docs/resources/variable
# resource "tfe_variable" "enable_gcp_provider_auth" {
